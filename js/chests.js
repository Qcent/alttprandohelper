(function(window) {
    ...
    window.dungeons = [{ // [0]
        ...
        caption: 'Desert Palace {book} + {glove} + {lantern}/{firerod}',
        is_beaten: false,
        is_beatable: function() {
    ...
    window.chests = [{ // [0]
        ...
        caption: 'Treasure Chest Minigame: Pay 30{rupeegreen}',
        is_opened: false,
        is_available: function() {
            return can_reach_outcast() ? 'available' : 'unavailable';
        }
    }, { // [24]
        caption: 'Bottle Vendor: Pay 100{rupeegreen}',
        is_opened: false,
        is_available: always
    }, { // [25]
        ...
        caption: 'King Zora: Pay 500{rupeegreen}',
        is_opened: false,
        is_available: function() {
        ...
        caption: 'Floating Island {glove2} + {mirror} + {hammer}/{hookshot}',
        is_opened: false,
        is_available: function() {
        ...
        caption: 'Dig-a-Thon: Pay 80{rupeegreen}',
        is_opened: false,
        is_available: function() {
            return can_reach_outcast() || items.agahnim && items.moonpearl && items.hammer ? 'available' : 'unavailable';
        }
        ...
        caption: 'Take the frog home {mirror} / return from DW',
        is_opened: false,
        is_available: function() {
            return items.moonpearl && items.glove === 2 ? 'available' : 'unavailable';
        }
    }, { // [61]
        caption: 'Fat Faire : Big bomb available after both 5+6{redcrystal}(2)',
        is_opened: false,
        is_available: function() {
            //crystal check
            var crystal_count = 0;
        ...
        caption: 'Master Sword Pedestal {pendant0}{pendant1}{pendant2} (check with {book})',
        is_opened: false,
        is_available: function() {
            var pendant_count = 0;
            for (var k = 0; k < 10; k++) {
